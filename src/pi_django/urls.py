...
urlpatterns = [
    ...
    url(r'Energy_bus_exercises_Mar_2016.html$', views.Energy_bus_exercisesPage.as_view(), name='Energy_bus_exercises'),
    url(r'Energy_bus_exercises_Oct_2014.html$', views.Energy_bus_exercisesPage.as_view(), name='Energy_bus_exercises'),
