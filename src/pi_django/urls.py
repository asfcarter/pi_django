...
urlpatterns = [
    ...
    url(r'Energy_bus_exercises_March_2021.html$', views.Energy_bus_exercisesMarch2021Page.as_view(), name='Energy_bus_exercisesMarch2021'),
    ...
    url(r'Energy_bus_exercises_Oct_2018.html$', views.Energy_bus_exercisesOct2018Page.as_view(), name='Energy_bus_exercisesOct2018'),
    url(r'Energy_bus_exercises_Aug_2018.html$', views.Energy_bus_exercisesAug2018Page.as_view(), name='Energy_bus_exercisesAug2018'),
    url(r'Energy_bus_exercises_July_2018.html$', views.Energy_bus_exercisesJuly2018Page.as_view(), name='Energy_bus_exercisesJuly2018'),
    url(r'Energy_bus_exercises_June_2018.html$', views.Energy_bus_exercisesJune2018Page.as_view(), name='Energy_bus_exercisesJune2018'),
    url(r'Energy_bus_exercises_May_2018.html$', views.Energy_bus_exercisesMay2018Page.as_view(), name='Energy_bus_exercisesMay2018'),
    url(r'Energy_bus_exercises_March_2018.html$', views.Energy_bus_exercisesMarch2018Page.as_view(), name='Energy_bus_exercisesMarch2018'),
    url(r'Energy_bus_exercises_February_2018.html$', views.Energy_bus_exercisesFebruary2018Page.as_view(), name='Energy_bus_exercisesFebruary2018'),
    url(r'Energy_bus_exercises_January_2018.html$', views.Energy_bus_exercisesJanuary2018Page.as_view(), name='Energy_bus_exercisesJanuary2018'),
    url(r'Energy_bus_exercises_December_2017.html$', views.Energy_bus_exercisesDecember2017Page.as_view(), name='Energy_bus_exercisesDecember2018'),
    url(r'Energy_bus_exercises_November_2017.html$', views.Energy_bus_exercisesNovember2017Page.as_view(), name='Energy_bus_exercisesNovember2017'),
    url(r'Energy_bus_exercises_July_2017.html$', views.Energy_bus_exercisesJuly2017Page.as_view(), name='Energy_bus_exercisesJuly2017'),
    url(r'Energy_bus_exercises_June_2017.html$', views.Energy_bus_exercisesJune2017Page.as_view(), name='Energy_bus_exercisesJune2017'),
    url(r'Energy_bus_exercises_May_2017.html$', views.Energy_bus_exercisesMay2017Page.as_view(), name='Energy_bus_exercisesMay2017'),
